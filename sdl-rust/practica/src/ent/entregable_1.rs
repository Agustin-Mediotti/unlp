use crate::ent::entregable_1::fecha::Fecha;
use rand::Rng;
...
impl Biblioteca {
    ...
    pub fn new(direccion: String, nombre: String, fecha: Fecha) -> Self {
    ...
    pub fn contar_prestamos_de_cliente(&self, cliente: Cliente) -> usize {
        self.prestamos_efectuados
            .iter()
            .filter(|f| {
                f.cliente.id_cliente == cliente.id_cliente && f.estado == EstadoPrestamo::Prestamo
            })
            .count()
    }
